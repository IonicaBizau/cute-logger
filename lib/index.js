 ...
 * @name log
 * @function
 * @param {Object} message The debug message that should be displayed
...
BugKiller.error = function (message) {
  return BugKiller.log(message, "error");
};

BugKiller.warn = function (message) {
  return BugKiller.log(message, "warn");
};

BugKiller.info = function (message) {
